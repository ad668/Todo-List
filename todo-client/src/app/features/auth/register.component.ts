...
@Component({
    ...
    <div class="auth-shell">
      <div class="auth-card">
        <div class="brand-panel">
          <h1>TaskFlow</h1>
          <p>Start tracking work and managing your operations from one clean workspace.</p>
          <div class="pill">Fast onboarding</div>
          <div class="pill">Secure access</div>
        </div>

        <div class="form-panel">
          <h2>Create account</h2>
          <p class="subtext">Register to manage tasks and monitor progress.</p>
  ...
  styles: [
    ...
    `.submit-btn{padding:12px 14px;border:none;border-radius:12px;background:#2563eb;color:white;font-weight:700;cursor:pointer;}` ,
